...
import { createRecordForm, recordGroup, recordNetTotal } from "./selectors.js";
import { products } from "./states.js";
import { v4 as uuidv4 } from 'uuid';

export const createRecordFormHandler = (event) => { //form m loz even m fik m ny pr ya ml
    event.preventDefault();
    // console.log("U submit form");
    //form htl ka information twy kho lan yu tr 
...
export const calculateRecordCostTotal = () => {
    let total = 0 ;
    //nodelist fik ny loz foreach nk loop pat mha ya
...
// };
//add yor sub kho 1 ku htl mhr alok lok
...
// event bubbling kho use htr tr / record-remove ka class fik ny top tan phn loz m ya lo parent kho call p tone tr 
...
export const recordGroupObserver = () => {
    const observerOptions = {
      ...
      const updateTotal = () => {
        ...
        recordNetTotal.innerHTML = total + tax;
      }
